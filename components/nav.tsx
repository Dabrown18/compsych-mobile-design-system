...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/mobile/components/status-chip', label: 'StatusChip' },
  ...
  },
  {
    ...
    collapsible: true,
    items: [
      { href: '/mobile/components/checkbox', label: 'Checkbox' },
      { href: '/mobile/components/form-fields', label: 'FormFields' },
      { href: '/mobile/components/input-field', label: 'Input' },
      { href: '/mobile/components/intake-fields', label: 'IntakeFields' },
      { href: '/mobile/components/primary-benefit-holder-fields', label: 'PrimaryBenefitHolderFields' },
      { href: '/mobile/components/radio-button', label: 'RadioButton' },
      { href: '/mobile/components/segmented-control', label: 'SegmentedControl' },
      { href: '/mobile/components/slider', label: 'Slider' },
      { href: '/mobile/components/switch', label: 'Switch' },
    ],
  },
  {
    heading: 'Content',
    collapsible: true,
    items: [
      { href: '/mobile/components/alert', label: 'Alert' },
      { href: '/mobile/components/avatar', label: 'Avatar' },
      { href: '/mobile/components/breadcrumb', label: 'Breadcrumb' },
      { href: '/mobile/components/body-text', label: 'BodyText' },
      { href: '/mobile/components/empty-state', label: 'EmptyState' },
      { href: '/mobile/components/form-step-header', label: 'FormStepHeader' },
      { href: '/mobile/components/header-text', label: 'HeaderText' },
      { href: '/mobile/components/list', label: 'List' },
      { href: '/mobile/components/list-item', label: 'ListItem' },
      { href: '/mobile/components/pagination', label: 'Pagination' },
      { href: '/mobile/components/progress-tracker', label: 'ProgressTracker' },
      { href: '/mobile/components/tooltip', label: 'Tooltip' },
    ],
  },
  {
    heading: 'Actions',
    collapsible: true,
    items: [
      { href: '/mobile/components/button', label: 'Button' },
      { href: '/mobile/components/snackbar', label: 'Snackbar' },
    ],
  },
  {
    heading: 'Organisms',
    ...
    items: [
      ...
      { href: '/mobile/components/info-action-sheet', label: 'InfoActionSheet' },
      { href: '/mobile/components/dialog', label: 'Dialog' },
      { href: '/mobile/components/crisis-close-modal', label: 'CrisisCloseModal' },
      { href: '/mobile/components/appointment-confirmation-sheet', label: 'AppointmentConfirmationSheet' },
      { href: '/mobile/components/calendar', label: 'Calendar' },
      { href: '/mobile/components/chat-bubble', label: 'ChatBubble' },
      { href: '/mobile/components/form-nav-bar', label: 'FormNavBar' },
      { href: '/mobile/components/global-loader', label: 'GlobalLoader' },
      { href: '/mobile/components/chat-input', label: 'ChatInput' },
      { href: '/mobile/components/resource-card', label: 'ResourceCard' },
      ...
      { href: '/mobile/components/web-view-modal', label: 'WebViewModal' },
    ],
  },
];
...
export function Nav() {
  ...
  return (
    <aside
      ...
      style={{
        borderColor:
          'var(--sys-color-outline-variant, #d7dbe0)',
        backgroundColor:
          'var(--sys-color-surface-container-low, #f9fafb)',
      }}
    >
                    ...
                    return (
                      <li key={item.label}>
                        <Link
                          ...
                          style={{
                            color: active
                              ? 'var(--sys-color-on-primary-container, inherit)'
                              : item.muted
                                ? 'var(--sys-color-on-surface-variant, #565f6c)'
                                : 'inherit',
...
function SectionHeading({
  ...
  return (
    <button
      ...
      /* Explicitly inherit font-family and fix font-weight so browser
         user-agent button styles (which set their own font shorthand) can't
         override the className. Matches the non-collapsible heading above. */
      style={{
        ...headingStyle,
